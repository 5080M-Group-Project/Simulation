...
for i in range(10000):
    ...
    joystick_input = -joystick.get_axis(1)  # Invert Y-axis (forward is usually negative)
    ...
    print(
        f"Joystick Input: {joystick_input:.2f} | Desired Velocity: {desired_velocity:.2f} m/s | Pitch: {np.degrees(pitch_angle):.2f}°")
